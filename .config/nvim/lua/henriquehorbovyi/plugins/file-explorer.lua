	...
	config = function()
		...
		nvimtree.setup({
			on_attach = function(bufnr)
				...
				-- Default mappings (you can keep the ones you want)
		...
		-- Root folder
		vim.api.nvim_set_hl(0, "NvimTreeRootFolder", { fg = "#efefef", bold = true })
		-- Indent markers
		vim.api.nvim_set_hl(0, "NvimTreeIndentMarker", { fg = "#827777" })
		vim.api.nvim_set_hl(0, "NvimTreeNormal", { bg = "#030303", fg = "#f0f0f0" })
		vim.api.nvim_set_hl(0, "NvimTreeCursorLine", { bg = "#1d1d1d" })
		vim.api.nvim_set_hl(0, "NvimTreeFolderIcon", { fg = "#aaaaaa" })
